...
**Theorem 5.1.** For any :math:`x_0 \in \mathbb{R}^n` the sequence :math:`\{x_k\}` generated by the conjugate direction algorithm converges to the solution :math:`x^*` of the linear system in at most :math:`n` steps.
